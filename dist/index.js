...
(() => {
  ...
  var require_ua_parser = __commonJS({
    "node_modules/.pnpm/@amplitude+ua-parser-js@0.7.33/node_modules/@amplitude/ua-parser-js/src/ua-parser.js"(exports, module) {
      init_live_reload();
  ...
  // src/anchor-tags.js
  init_live_reload();
  function installAndScrollAnchorTags() {
  ...
  function isLikelyInvalidName(name) {
    ...
    if (vowelRatio < 0.15 || vowelRatio > 0.7)
      score += 2;
    if (/asdf|qwer|zxcv|hjkl/i.test(name))
      score += 3;
    if (/[^aeiou\s]{6,}/i.test(name))
      score += 2;
    if (/[^a-zàáâãäåæçèéêëìíîïðñòóôõöøùúûüýþÿāăąćčďđēėęěğģīįķĺļľłńņňőœŕřśşšţťũūůűųźżžșțə\s'-]/i.test(
      name
    ))
      score += 3;
  ...
  var $nav = $(".nav");
  var $navWrap = $(".nav_menu-wrap");
  var $navMenu = $(".nav_menu");
  var $navItems = $navWrap.find(".nav_menu-item, .nav_part");
  var $navBrand = $(".nav_part").eq(0);
  var $navHam = $(".nav_menu-ham");
  var $navLinks = $(".nav_menu-link");
  var $menuInner = $(".nav_menu-inner");
  var $menuBg = $(".nav_menu-inner-bg");
  var $menuBack = $(".nav_menu-back");
  var $allTriggers = $("[data-dropdown-trigger]");
  var $allTargets = $("[data-dropdown-target]");
  ...
  function setupMobile() {
    ...
    $navLinks.on("click", function(e) {
      const targetName = $(this).attr("data-dropdown-trigger");
      if (targetName)
        handleTriggerClick(e, targetName);
    });
  ...
  function initStoriesCards() {
    $(".cs_wrap").each(function(index) {
      ...
      function cloneSlides(sliderEl, times = 2) {
        var $track = $(".cs-wrap_inner .swiper-wrapper");
  ...
  var revealLetters = (elements, baseDelay = 0.01) => {
  ...
  // src/tracking/amplitude.js
  init_live_reload();

  // src/forms/sniffEmail.js
  init_live_reload();
  ...
  // node_modules/.pnpm/@amplitude+experiment-js-client@1.16.2/node_modules/@amplitude/experiment-js-client/dist/experiment.esm.js
  init_live_reload();

  // node_modules/.pnpm/@amplitude+experiment-core@0.11.0/node_modules/@amplitude/experiment-core/dist/experiment-core.esm.js
  init_live_reload();
        ...
        try {
          for (var conditions_1 = __values(conditions), conditions_1_1 = conditions_1.next(); !conditions_1_1.done; conditions_1_1 = conditions_1.next()) {
            ...
            try {
              ...
              try {
                if (innerConditions_1_1 && !innerConditions_1_1.done && (_b = innerConditions_1.return))
                  _b.call(innerConditions_1);
              } finally {
                if (e_4)
                  throw e_4.error;
              }
  ...
  var isEqual = function(obj1, obj2) {
    ...
    try {
      ...
      try {
        if (primitive_1_1 && !primitive_1_1.done && (_a = primitive_1.return))
          _a.call(primitive_1);
      } finally {
        if (e_1)
          throw e_1.error;
  ...
  var safeGlobal2 = typeof globalThis !== "undefined" ? globalThis : typeof global !== "undefined" ? global : self;
  var AnalyticsConnector = (
    ...
    function() {
      ...
      AnalyticsConnector2.getInstance = function(instanceName) {
        if (!safeGlobal2["analyticsConnectorInstances"]) {
          safeGlobal2["analyticsConnectorInstances"] = {};
        }
        if (!safeGlobal2["analyticsConnectorInstances"][instanceName]) {
          safeGlobal2["analyticsConnectorInstances"][instanceName] = new AnalyticsConnector2();
        }
        return safeGlobal2["analyticsConnectorInstances"][instanceName];
      };
  ...
  var parseAmplitudeCookie = function(apiKey, newFormat) {
    ...
    try {
      for (var cookies_1 = __values3(cookies), cookies_1_1 = cookies_1.next(); !cookies_1_1.done; cookies_1_1 = cookies_1.next()) {
        var cookie = cookies_1_1.value;
        var _b = __read3(cookie.split("=", 2), 2), cookieKey = _b[0], cookieValue = _b[1];
        if (cookieKey === key) {
      ...
      try {
        if (cookies_1_1 && !cookies_1_1.done && (_a = cookies_1.return))
          _a.call(cookies_1);
      } finally {
        if (e_1)
          throw e_1.error;
  ...
  var AmplitudeIntegrationPlugin = (
    /** @class */
    function() {
      function AmplitudeIntegrationPlugin2(apiKey, connector, timeoutMillis) {
      ...
      AmplitudeIntegrationPlugin2.prototype.setup = function(config, client) {
        return __awaiter2(this, void 0, void 0, function() {
          return __generator2(this, function(_a) {
            ...
            return [2, this.waitForConnectorIdentity(this.timeoutMillis)];
          });
        });
      };
      AmplitudeIntegrationPlugin2.prototype.getUser = function() {
      ...
      AmplitudeIntegrationPlugin2.prototype.track = function(event) {
      ...
      AmplitudeIntegrationPlugin2.prototype.loadPersistedState = function() {
      ...
      AmplitudeIntegrationPlugin2.prototype.commitIdentityToConnector = function(user) {
      ...
      AmplitudeIntegrationPlugin2.prototype.waitForConnectorIdentity = function(ms) {
        return __awaiter2(this, void 0, void 0, function() {
          var identity;
          var _this = this;
          return __generator2(this, function(_a) {
      ...
      return AmplitudeIntegrationPlugin2;
    }()
  );
  ...
  var IntegrationManager = (
    /** @class */
    function() {
      function IntegrationManager2(config, client) {
        var _this = this;
        var _a;
      ...
      IntegrationManager2.prototype.ready = function() {
        if (!this.integration) {
          return Promise.resolve();
        }
        return this.isReady;
      };
      IntegrationManager2.prototype.setIntegration = function(integration) {
        var _this = this;
      ...
      IntegrationManager2.prototype.getUser = function() {
        if (!this.integration) {
          return {};
        }
        return this.integration.getUser();
      };
      IntegrationManager2.prototype.track = function(exposure) {
        if (this.cache.shouldTrack(exposure)) {
          var event_1 = this.getExposureEvent(exposure);
          this.queue.push(event_1);
        }
      };
      IntegrationManager2.prototype.getExposureEvent = function(exposure) {
        var _a, _b, _c;
        var event = {
          eventType: "$exposure",
      ...
      return IntegrationManager2;
    }()
  );
  var SessionDedupeCache = (
    /** @class */
    function() {
      function SessionDedupeCache2(instanceName) {
      ...
      SessionDedupeCache2.prototype.shouldTrack = function(exposure) {
        var _a;
      ...
      SessionDedupeCache2.prototype.loadCache = function() {
        if (this.isSessionStorageAvailable) {
          var storedCache = safeGlobal.sessionStorage.getItem(this.storageKey);
          this.inMemoryCache = storedCache ? JSON.parse(storedCache) : {};
        }
      };
      SessionDedupeCache2.prototype.storeCache = function() {
        if (this.isSessionStorageAvailable) {
          safeGlobal.sessionStorage.setItem(this.storageKey, JSON.stringify(this.inMemoryCache));
        }
      };
      return SessionDedupeCache2;
    }()
  );
  var PersistentTrackingQueue = (
    /** @class */
    function() {
      function PersistentTrackingQueue2(instanceName, maxQueueSize) {
      ...
      PersistentTrackingQueue2.prototype.push = function(event) {
        this.loadQueue();
        this.inMemoryQueue.push(event);
        this.flush();
        this.storeQueue();
      };
      PersistentTrackingQueue2.prototype.setTracker = function(tracker) {
        var _this = this;
      ...
      PersistentTrackingQueue2.prototype.flush = function() {
        var e_1, _a;
        if (!this.tracker)
          return;
        if (this.inMemoryQueue.length === 0)
          return;
        try {
          for (var _b = __values3(this.inMemoryQueue), _c = _b.next(); !_c.done; _c = _b.next()) {
      ...
      PersistentTrackingQueue2.prototype.loadQueue = function() {
      ...
      PersistentTrackingQueue2.prototype.storeQueue = function() {
        if (this.isLocalStorageAvailable) {
      ...
      PersistentTrackingQueue2.prototype.loadFlushStore = function() {
        this.loadQueue();
        this.flush();
        this.storeQueue();
      };
      return PersistentTrackingQueue2;
    }()
  );
  ...
  var LoadStoreCache = (
    ...
    function() {
      ...
      LoadStoreCache2.prototype.putAll = function(values) {
        var e_1, _a;
        try {
          for (var _b = __values3(Object.keys(values)), _c = _b.next(); !_c.done; _c = _b.next()) {
            var key = _c.value;
      ...
      LoadStoreCache2.prototype.load = function() {
        ...
        var values = {};
        try {
          for (var _c = __values3(Object.keys(jsonValues)), _d = _c.next(); !_d.done; _d = _c.next()) {
            var key = _d.value;
            try {
              var value = void 0;
              if (this.transformer) {
  ...
  var SessionStorage = (
    ...
    function() {
      ...
      SessionStorage2.prototype.put = function(key, value) {
        var _a;
        (_a = this.globalScope) === null || _a === void 0 ? void 0 : _a.sessionStorage.setItem(key, value);
      };
      SessionStorage2.prototype.delete = function(key) {
        var _a;
  ...
  var filterNullUndefined = function(obj) {
    ...
    var filtered = {};
    try {
      for (var _b = __values3(Object.entries(obj)), _c = _b.next(); !_c.done; _c = _b.next()) {
  ...
  var convertUserToContext = function(user) {
    ...
    try {
      for (var _d = __values3(Object.keys(user.groups)), _e = _d.next(); !_e.done; _e = _d.next()) {
  ...
  var minFlagPollerIntervalMillis = 6e4;
    ...
    function() {
      function ExperimentClient2(apiKey, config) {
        ...
        this.config = __assign3(__assign3(__assign3({}, Defaults), config), {
          ...
          flagConfigPollingIntervalMillis: config.flagConfigPollingIntervalMillis < minFlagPollerIntervalMillis ? minFlagPollerIntervalMillis : (_c = config.flagConfigPollingIntervalMillis) !== null && _c !== void 0 ? _c : Defaults.flagConfigPollingIntervalMillis
        });
        ...
        var storage;
        var storageInstanceName = internalInstanceName ? "".concat(this.config.instanceName, "-").concat(internalInstanceName) : this.config.instanceName;
      ...
      ExperimentClient2.prototype.fetch = function() {
        return __awaiter2(this, arguments, void 0, function(user, options) {
          var e_2;
          if (user === void 0) {
            user = this.user;
          }
      ...
      ExperimentClient2.prototype.evaluate = function(flagKeys) {
        ...
        var variants = {};
        try {
          for (var _b = __values3(Object.keys(evaluationVariants)), _c = _b.next(); !_c.done; _c = _b.next()) {
      ...
      ExperimentClient2.prototype.cleanUserPropsForFetch = function(user) {
        var cleanedUser = __assign3({}, user);
      ...
      ExperimentClient2.prototype.doFetch = function(user, timeoutMillis, options) {
        return __awaiter2(this, void 0, void 0, function() {
          ...
          return __generator2(this, function(_d) {
            switch (_d.label) {
              case 0:
                return [4, this.addContextOrWait(user)];
              case 1:
                user = _d.sent();
              ...
              case 2:
                ...
                variants = {};
                try {
                  for (_a = __values3(Object.keys(results)), _b = _a.next(); !_b.done; _b = _a.next()) {
                    key = _b.value;
            ...
            switch (_a.label) {
              ...
              case 2:
                return [4, this.flagApi.getFlags({
                  ...
                  user: (user === null || user === void 0 ? void 0 : user.user_id) || (user === null || user === void 0 ? void 0 : user.device_id) ? { user_id: user === null || user === void 0 ? void 0 : user.user_id, device_id: user === null || user === void 0 ? void 0 : user.device_id } : void 0
                })];
              case 3:
                flags = _a.sent();
                this.flags.clear();
      ...
      ExperimentClient2.prototype.addContext = function(user) {
        ...
        var mergedUserProperties = __assign3(__assign3(__assign3({}, providedUser === null || providedUser === void 0 ? void 0 : providedUser.user_properties), integrationUser.user_properties), user === null || user === void 0 ? void 0 : user.user_properties);
        return __assign3(__assign3(__assign3(__assign3({ library: "experiment-js-client/".concat(version2) }, providedUser), integrationUser), user), { user_properties: mergedUserProperties });
      };
      ExperimentClient2.prototype.addContextOrWait = function(user) {
        return __awaiter2(this, void 0, void 0, function() {
          return __generator2(this, function(_a) {
            switch (_a.label) {
              case 0:
      ...
      ExperimentClient2.prototype.debug = function(message) {
        ...
        if (this.config.debug) {
          console.debug.apply(console, __spreadArray2([message], __read3(optionalParams), false));
        }
      };
      ...
      ExperimentClient2.prototype.addPlugin = function(plugin) {
  ...
  var DefaultUserProvider = (
    /** @class */
    function() {
      function DefaultUserProvider2(userProvider, apiKey) {
        var _a, _b, _c;
        this.globalScope = getGlobalScope();
        this.userAgent = typeof ((_a = this.globalScope) === null || _a === void 0 ? void 0 : _a.navigator) !== "undefined" ? (_b = this.globalScope) === null || _b === void 0 ? void 0 : _b.navigator.userAgent : void 0;
        this.ua = new import_ua_parser_js.UAParser(this.userAgent).getResult();
      ...
      DefaultUserProvider2.prototype.getBrowser = function(ua) {
        var _a;
      ...
      DefaultUserProvider2.prototype.getCookie = function() {
        var _a, _b, _c, _d, _e;
        if (!((_b = (_a = this.globalScope) === null || _a === void 0 ? void 0 : _a.document) === null || _b === void 0 ? void 0 : _b.cookie)) {
          return void 0;
        }
        return Object.fromEntries((_e = (_d = (_c = this.globalScope) === null || _c === void 0 ? void 0 : _c.document) === null || _d === void 0 ? void 0 : _d.cookie) === null || _e === void 0 ? void 0 : _e.split("; ").map(function(c) {
          return c.split("=");
        }));
      };
      DefaultUserProvider2.prototype.getLandingUrl = function() {
        var _a, _b;
        try {
      ...
      DefaultUserProvider2.prototype.getFirstSeen = function() {
        try {
          var localUser = JSON.parse(this.localStorage.get(this.storageKey) || "{}");
          if (!localUser.first_seen) {
            localUser.first_seen = (Date.now() / 1e3).toString();
      ...
      DefaultUserProvider2.prototype.getUrlParam = function() {
        var e_1, _a;
        var _b;
        if (!this.globalScope) {
          return void 0;
        ...
        try {
          ...
          try {
            for (var _c = __values3(url.searchParams), _d = _c.next(); !_d.done; _d = _c.next()) {
              var _e = __read3(_d.value, 2), name_1 = _e[0], value = _e[1];
              params[name_1] = __spreadArray2(__spreadArray2([], __read3((_b = params[name_1]) !== null && _b !== void 0 ? _b : []), false), __read3(value.split(",")), false);
            }
          } catch (e_1_1) {
            e_1 = { error: e_1_1 };
          } finally {
        ...
        return Object.entries(params).reduce(function(acc, _a2) {
          var _b2 = __read3(_a2, 2), name = _b2[0], value2 = _b2[1];
          acc[name] = value2.length == 1 ? value2[0] : value2;
          return acc;
        }, {});
      };
  ...
  var initializeWithAmplitudeAnalytics = function(apiKey, config) {
    var plugin = function() {
      return new AmplitudeIntegrationPlugin(apiKey, AnalyticsConnector.getInstance(getInstanceName(config)), 1e4);
    };
  ...
  var getInstanceKey = function(apiKey, config) {
    ...
    return internalInstanceNameSuffix ? "".concat(instanceName, ".").concat(apiKey, ".").concat(internalInstanceNameSuffix) : "".concat(instanceName, ".").concat(apiKey);
  };
  var newExperimentClient = function(apiKey, config) {
    return new ExperimentClient(apiKey, __assign3(__assign3({}, config), { userProvider: new DefaultUserProvider(config === null || config === void 0 ? void 0 : config.userProvider, apiKey) }));
  };
  ...
  var StubExperimentClient = (
    ...
    function() {
      ...
      StubExperimentClient2.prototype.fetch = function(user, options) {
        return __awaiter2(this, void 0, void 0, function() {
          return __generator2(this, function(_a) {
            return [2, this];
          });
...
` : "";
  ...
  $(document).ready(function() {
    ...
    if (ctaButton && contentSection) {
      let updateCTAVisibility2 = function() {
      ...
      var updateCTAVisibility = updateCTAVisibility2;
